...
export class GameServiceClient {
  ...
  createAndJoinRoom(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.CreateAndJoinRoomResponse | null
    ) => void
  ): void;
  createAndJoinRoom(
    requestMessage: werewolf_pb.CreateAndJoinRoomRequest,
  ...
  updateGameConfig(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.UpdateGameConfigResponse | null
    ) => void
  ): void;
  updateGameConfig(
    requestMessage: werewolf_pb.UpdateGameConfigRequest,
  ...
  joinRoom(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.JoinRoomResponse | null
    ) => void
  ): void;
  joinRoom(
    requestMessage: werewolf_pb.JoinRoomRequest,
  ...
  getRoom(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.GetRoomResponse | null
    ) => void
  ): void;
  getRoom(
    requestMessage: werewolf_pb.GetRoomRequest,
  ...
  takeSeat(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.TakeSeatResponse | null
    ) => void
  ): void;
  takeSeat(
    requestMessage: werewolf_pb.TakeSeatRequest,
  ...
  reassignRoles(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.ReassignRolesResponse | null
    ) => void
  ): void;
  reassignRoles(
    requestMessage: werewolf_pb.ReassignRolesRequest,
  ...
  vacateSeat(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.VacateSeatResponse | null
    ) => void
  ): void;
  vacateSeat(
    requestMessage: werewolf_pb.VacateSeatRequest,
  ...
  startGame(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.StartGameResponse | null
    ) => void
  ): void;
  startGame(
    requestMessage: werewolf_pb.StartGameRequest,
  ...
  takeAction(
    ...
    callback: (
      error: ServiceError,
      responseMessage: werewolf_pb.TakeActionResponse | null
    ) => void
  ): void;
  takeAction(
    requestMessage: werewolf_pb.TakeActionRequest,
